                ...
                <div class="form-container">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                        ...
                        <div class="form-group">
                            <label for="codePayments">Mã Phương Thức:</label>
                            <input type="text" id="codePayments" name="codePayments" class="form-control" required>
                            <label for="namePayment">Tên Phương Thức:</label>
                            <input type="text" id="namePayment" name="namePayment" class="form-control" required>
                            <label for="affiliateBank">Chi Nhánh Ngân Hàng:</label>
                            <input type="text" id="affiliateBank" name="affiliateBank" class="form-control" required>
                        </div>
                        <div class="form-group">
