    ...
    function searchSupplier($str)
    {
        ...
        if (count($arr) > 0) {
            foreach ($arr as $item) {
                ...
                if (
                    strpos($nameSupplier, $str) !== false || strpos($codeSupplier, $str) !== false  ||
                    strpos($phoneNumber, $str) !== false || strpos($address, $str) !== false || strpos($email, $str) !== false || strpos($brandSupplier, $str) !== false
                ) {
                    $obj = array(
                        "codeSupplier" => $codeSupplier,
                        "nameSupplier" => $nameSupplier,
